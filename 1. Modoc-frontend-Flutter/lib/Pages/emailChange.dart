            ...
            children:[
                ...
                children: [
                  ...
                  InkWell(
                    child: Container(
                      ...
                      padding: EdgeInsets.fromLTRB(0, 0, customWidth(3), 0),
                      height: customHeight(40),
                      width: customWidth(70),
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.horizontal(right: Radius.circular(40)),
                    ...
                    onTap: ()async{
                      if(mailValidation(newEmail)){
                        if(await sendOtp(newEmail)){
                          ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: ()async{
                      if(await validateOTP(newEmail,mailOTP)){
                        canChange=true;
                        ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                                backgroundColor: Colors.green,
              ...
              SizedBox(width: customWidth(180),
                child: ElevatedButton(
                  ...
                  onPressed: ()async{
                    if(passVer){
                    var x=await emailChangeAPI(URL,UserName,newEmail);
                        ...
                        return AlertDialog(
                          title:Column(
                            children: [
                              ...
                              Text("Email Changed Successfully!",style:TextStyle(fontSize: customHeight(15)),),
                            ],
                          ),
                          ...
                          SnackBar(
                              ...
                              content: Row(
                                children: [
                                  ...
                                  SizedBox(width: 5),
                                  Text(
                                    "Can't update Email without password verification",
                                    style: TextStyle(
                                      fontStyle: FontStyle.italic,
                                    ),
                                  )
